...
function GoToActionSizeHelperComp() {
    ...
    return (
        <div className={ansiViewerStyle.ansiContainer} style={AnsiContainerConstantStyle}>

            {/*This should look the same as LineCode component */}
            <div className={`${ansiViewerStyle.line} ansi-line`} style={AnsiLineConstantStyle}>
                <code ref={lineNumberRef} className="line-number noselect">7</code>
