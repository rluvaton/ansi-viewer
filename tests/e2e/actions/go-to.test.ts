...
test.describe('Go-to Action Tests', () => {
  ...
  test('Validate go-to action navigates to the correct line and column', async ({ page }) => {
  ...
  test('Verify scrolling functionality works as expected for both small and large files', async ({ page }) => {
  ...
  test('Verify initial go-to input value is the current caret position', async ({ page }) => {
